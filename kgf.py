...
async def start_yukki():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
            await idk(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
            await idk(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
            await idk(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
            await idk(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
            await wdk(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
            await wdk(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
            await wdk(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
            await wdk(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
            await hdk(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
            await hdk(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
            await hdk(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
            await hdk(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
            await put(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
            await put(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
            await put(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
            await put(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
    ...
    if tsix:
        ...
        try:
            ...
            await eag(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
            await eag(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
            await eag(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
            await eag(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
            await eag(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
    ...
    if tseven:
        ...
        try:
            ...
            await gle.start()
            await gle(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
            await gle(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
            await gle(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
            await gle(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
            await gle(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
    ...
    if teight:
        ...
        try:
            ...
            await wal.start()
            await wal(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
            await wal(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
            await wal(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
            await wal(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
            await wal(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
    ...
    if tnine:
        ...
        try:
            ...
            await aaa.start()
            await aaa(functions.channels.JoinChannelRequest(channel="@secret_cityy"))               
            await aaa(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
            await aaa(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
            await aaa(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
            await aaa(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
    ...
    if thirty:
        ...
        try:
            ...
            await boy.start()
            await boy(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
            await boy(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
            await boy(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
            await boy(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
            await boy(functions.channels.JoinChannelRequest(channel="@secret_cityy"))
